...
public class SuccessTickView extends View {
    ...
    private final float CONST_RADIUS = dip2px(2f);
    ...
    private final float MIN_LEFT_RECT_W = dip2px(6f);
    private final float MAX_RIGHT_RECT_W = CONST_RIGHT_RECT_W + dip2px(11f);
